...
export default class Config {
  ...
  /**
   * Take another config object and return new Config whose
   * config is created from this instance's config and the argument.
   * @param {Object} other
   * @return {Config}
   */
  merge(other) {
  ...
  /**
   * Return a copy of the config object passed to the constructor.
   * @return {Object}
   */
  getRawConfig() {
